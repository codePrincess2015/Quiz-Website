...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "censored";
	public static final String MYSQL_PASSWORD = "censored";
	public static final String MYSQL_DATABASE_SERVER = "censored";
	public static final String MYSQL_DATABASE_NAME = "censored";
